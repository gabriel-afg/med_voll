...
import md.voll.api.dtos.DadosEndereco;
...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaData() {
        var proximaSegundoAs10 = LocalDate.now()
        ...
        cadastrarConsulta(medico, paciente, proximaSegundoAs10);

        var medicoLivre = medicoRepository.escolherMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA, proximaSegundoAs10);
    ...
    void escolherMedicoAleatorioLivreNaDataDisponivel() {
        var proximaSegundoAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10,0);
